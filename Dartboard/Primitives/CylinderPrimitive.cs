...
namespace Dartboard.Primitives
{
    /// <summary>
    ...
    public class CylinderPrimitive : GeometricPrimitive
    {
                                 ...
                                 float height, float diameter, int tessellation)
        {
            ...
            CreatePoint(tessellation, height, 0.25f, radius, Vector3.Up);
            CreateCap(tessellation, height, radius, Vector3.Down);

            InitializePrimitive(graphicsDevice);
        }

        void CreatePoint(int tessellation, float cylHeight, float capHeight, float radius, Vector3 normal)
        {
            // Create cap indices.
